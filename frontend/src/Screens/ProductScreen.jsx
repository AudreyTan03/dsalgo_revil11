    ...
    return (
      <div className="App">
        <div className="overlay">
          ...
          {userId !== product.user && (
            <div className="ratings">
              ...
              <button className="review-button bigger-button" onClick={handleAddToCart}>Reviews</button>
        ...
        <div className="gray-section">
          ...
          <img src={product.image} alt={product.name} style={{ marginRight: '700px', width: '100%', maxWidth: '400px' }} />
          </p>
