...
function RegisterScreen() {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      navigate(`https://revilcpe201-6018f6621dc2.herokuapp.com/verify-otp/user_id/${user_id}/otp/${otp_id}`); // Redirect to OTP verification screen with user_id and otp_id
    } catch (error) {
