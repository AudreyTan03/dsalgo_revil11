...
export const VIDEO_SUBSCRIBE_REQUEST = 'VIDEO_SUBSCRIBE_REQUEST';
export const VIDEO_SUBSCRIBE_SUCCESS = 'VIDEO_SUBSCRIBE_SUCCESS';
export const VIDEO_SUBSCRIBE_FAIL = 'VIDEO_SUBSCRIBE_FAIL';