...
import updateProductReducer from './reducers/editReducer';
...
const rootReducer = combineReducers({
    ...
    listQuestionsReducer: listQuestionsReducer,
    listUserProductQuestionsReducer: listUserProductQuestionsReducer,
